...
pet_data = [
  ...
  { name: "Chopper", age: 2, gender: "male", species: "dog", color: "Brown", birthdate: Date.new(2023, 2, 5), photo_url: "https://upload.wikimedia.org/wikipedia/commons/4/4d/Cat_November_2010-1a.jpg"},
  { name: "Momo", age: 5, gender: "female", species: "rabbit", color: "White", birthdate: Date.new(2020, 7, 20), photo_url: "https://upload.wikimedia.org/wikipedia/commons/4/4d/Cat_November_2010-1a.jpg" },
  { name: "Taro", age: 6, gender: "male", species: "parrot", color: "Green", birthdate: Date.new(2019, 11, 10), photo_url: "https://upload.wikimedia.org/wikipedia/commons/4/4d/Cat_November_2010-1a.jpg" }
]
...
Task.create(
  ...
  user: User.find_by(email: "owen@gmail.com")
)
...
Task.create(
  ...
  user: User.find_by(email: "marie@gmail.com")
)

Task.create(
  description: "Adding food to bowl",
  title: "Feed",
  due_date: Date.today,
  pet: Pet.find_by(name: "Chopper"),
